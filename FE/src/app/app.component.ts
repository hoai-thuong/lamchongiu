...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, HeaderComponent, LoginComponent, DonationListComponent, DonationCardComponent, CardDetailComponent, SideBarComponent, FooterComponent, FormsModule, TestComponent, CommonModule],
